...
const datos = {
    ...
    empleado: {
        _id:        ObjectId("601575771a74ac9e08ff723f"),
        id_usuario: "12345678",
    ...
    tablas: ["Macroproceso", "Proceso", "Actividad"]

    tablaN1:    [
        {
            idNivelHijo: "001",
            nombreNivel: "Direccionamiento estrategico"
        },
        {
            idNivelHijo: "002",
    ...
    tablaN2:    [
        {
            nombreNivel: "Planeación estrategica",
            idNivelPadre: "001",
            idNivelHijo: "001001"
        },
        {
        ...
        {
            nombreNivel: "PETI (Planeación Estrategica de TI)",
            idNivelPadre: "011",
            idNivelHijo: "011001"
        },
        {
        ...
        {
            nombreNivel: "Control y Garantia de TI",
            idNivelPadre: "011",
            idNivelHijo: "011003"
        }
    ],
    ...
    tablaN3:    [
        ...
        {
            idNivelPadre: "010003",
            idNivelHijo: "010003001",
            nombreNivel: "Plan de Comunicaciones ",
            descripcion: "Cras ac orci eleifend, congue risus sed, dictum velit. Nam rhoncus consequat elit quis varius. Cras condimentum eu turpis nec porttitor. Quisque eu erat sit amet massa tempor gravida. Integer interdum metus leo, id dictum libero molestie id. Integer sed libero condimentum, mattis quam quis, dictum orci. In mollis eros lectus, ac fermentum augue porttitor a. Sed at finibus orci, ac hendrerit urna. Interdum et malesuada fames ac ante ipsum primis in faucibus."
        },
        {
            idNivelPadre: "010003",
            idNivelHijo: "010003002",
    ...
    = require("../assets/databases/Nivel1.json")     
const tablaN2 = require("../assets/databases/Nivel2.json")    
const tablaN3 = require("../assets/databases/Nivel3.json") 
const 
...
const reporteTiempos =[]
    ...
    // Cargue la table de tiempos

    return (
        <div>
    <CapturaTiempos datos={datos} reporteTiempos={reporteTiempos} />            
        </div>
    )
}
