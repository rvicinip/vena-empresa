...
const   empresa = {
        _id:    ObjectId("60155c7052eab65a94b04d10"),
        nit:    "9001234567",
...
// Debo enviarle informacion hacia arriba de ñp que ud necesita para actualizar la tabla de Captura de Tiempos de todos los empleados
    ...
    return (
        <div>
            <CapturaTiempos empresa={empresa} empleado={empleado} tablas={tablas} frecuencia={frecuencia} diccionario={diccionario} reporteTiempos={reporteTiempos} />            
        </div>
    )
}
