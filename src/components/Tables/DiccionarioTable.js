...
function crearDiccionarioTabla () {
const diccionario =  [
  {
  ...
  return (
    <>
      <Container fluid>
        <Row>  
          <Col md="12">
            <h4 className="title">Diccionario de Actividades</h4>
            <p className="category">
              Esta es el Diccionario de Actividades que los consultores tienen disponibles para su estudio o modificación
            </p>
            <Card>
              <Card.Body>
                <ReactTable
...
export default DiccionarioTable;
