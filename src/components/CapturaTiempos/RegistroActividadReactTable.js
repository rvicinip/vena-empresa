...
function RegistroActividad(props) {
  ...
  const opcionesUnTpo = [{unidad: "minuto(s)", tipo: "0"}, {unidad: "hora(s)", tipo: "1"}, {unidad:"dia(s)", tipo: "2"}]
  const [diccUnTpo, setDiccUnTpo] = useState(["minuto(s)", "hora(s)", "dia(s)"]);
